...
import {
  JourneyTemplate, ReadJourneyTemplatesDocument, ReadJourneyTemplatesQuery,
  useCreateJourneyTemplateMutation, useDeleteJourneyTemplateMutation,
  useReadJourneyTemplatesQuery, useUpdateJourneyTemplateMutation,
...
export function useCreateJourneyTemplate() {
  return useCreate<JourneyTemplate, ReadJourneyTemplatesQuery>(
    useCreateJourneyTemplateMutation, 'JourneyTemplate', ReadJourneyTemplatesDocument,
  );
}

export function useUpdateJourneyTemplate() {
  return useUpdate<JourneyTemplate>(
    useUpdateJourneyTemplateMutation, 'JourneyTemplate',
  );
}

export function useDestroyJourneyTemplate() {
  return useDestroy<JourneyTemplate, ReadJourneyTemplatesQuery>(
    useDeleteJourneyTemplateMutation, 'JourneyTemplate', ReadJourneyTemplatesDocument,
  );
}
